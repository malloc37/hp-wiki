...
function Profile () {
    ...
    if(char.image !== "") {
        ...
        image = "https://www.diabetes.ie/wp-content/uploads/2017/02/no-image-available.png"
    }
    
    return (
        <Container style={{backgroundImage: "url(" + theme + ")", backgroundRepeat: "no-repeat", backgroundSize: "cover", height: "100%"}} fluid>
            <Col>
                <h1 style={{color: "white", display: "flex", justifyContent: "center"}}>{char.name}</h1>
                <Row xs={12} style={{backgroundColor: "rgba(0, 0, 0, 0.5)", paddingTop: "5%" , paddingBottom: "5%"}}>
                    <Col xs={12} style={{display: "flex", justifyContent: "center", alignItems: "center"}}>
                        <div style={{width: "200px"}}>
                            <Image src={image} rounded="true" thumbnail="true"></Image>
                        </div>
                    </Col>
                    <Col style={{ display: "flex", justifyContent: "center" }} xs={12}>
                        <ul style={{listStyle: "none", padding: "0",paddingTop: "5%", color: "white"}}>
                                ...
                                <li>House: {char.house}</li>
                                <li>Date of Birth: {char.dateOfBirth}</li>
                                <li>Ancestry: {char.ancestry}</li>
                                <li>Patronus: {char.patronus}</li>
                                <li>Actor: {char.actor}</li>
                            </ul>
                        </Col>
                    </Row>
                </Col>
...
//Swithcing over themes for houses
function getTheme(char) {
    var theme = ""
